...
res.status(200).json({message:"Notification Accessed successfully", notifications})

    }catch(error){
        res.status(500).json({message:"Notifications could not be accessed", error:error})
    }
}
